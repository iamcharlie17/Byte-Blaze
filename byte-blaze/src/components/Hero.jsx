        ...
        <div className="hero-content text-center">
          <div className="max-w-lg">
            <h1 className="text-5xl font-bold">
              Welcome to{' '}
              <span className="text-primary bg-gradient-to-r from-primary via-blue-500 to-secondary text-transparent bg-clip-text animate-gradient animatedgradient bg-300%">
                ByteBlaze
              </span>
            </h1>
            <p className="py-6">
